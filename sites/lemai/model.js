...
const LemaiLead = sequelize.define(
  "LemaiLead",
  {
    ...
    sales_team_size: {
      type: DataTypes.ENUM(
        "SIZE_0_5", "SIZE_5_10", "SIZE_10_25",
        "SIZE_25_50", "SIZE_50_100", "ABOVE_100"
      ),
      allowNull: true,
    },
    ...
    heard_from: {
      type: DataTypes.ENUM(
        "GOOGLE_SEARCH", "FB_INSTAGRAM", "SOCIAL_MEDIA",
  ...
  {
    tableName:  "leads",    // ← same existing table — no migration needed
    timestamps: true,
    underscored: true,
